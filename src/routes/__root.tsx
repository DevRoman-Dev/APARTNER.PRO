...
function NotFoundComponent() {
  ...
  let locale: "en" | "uk" | "ru" = "en";
  if (path.startsWith("/uk")) locale = "uk";
  else if (path.startsWith("/ru")) locale = "ru";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "preload", as: "font", type: "font/woff2", href: "/fonts/jetbrains-mono/jetbrains-mono-latin-500-normal.woff2", crossOrigin: "anonymous" },
    ],
  }),
...
function RootShell({ children }: { children: ReactNode }) {
  ...
  const lang = state.matches?.[1]?.params?.lang || "en";
