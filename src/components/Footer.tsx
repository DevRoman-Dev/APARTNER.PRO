      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <Link to={localePath(locale, "/portfolio")} className="hover:text-accent">
                {t(locale, "nav.portfolio")}
              </Link>
            </li>
            <li>
              <Link to={localePath(locale, "/blog")} className="hover:text-accent">
                {t(locale, "nav.blog")}
              </Link>
            </li>
            <li>
              <Link to={localePath(locale, "/about")} className="hover:text-accent">
                {t(locale, "nav.about")}
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <a href="mailto:info@apartner.pro" className="hover:text-accent">
                info@apartner.pro
              </a>
            </li>
            <li>
